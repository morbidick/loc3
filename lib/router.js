...
Router.configure({
  ...
  waitOn: function () {
  return [Meteor.subscribe('items'),Meteor.subscribe('locations'),Meteor.subscribe('userData'),Meteor.subscribe('teams'),Meteor.subscribe('transports'),Meteor.subscribe('listings'),Meteor.subscribe('files')];
  }
});
